...
const { backupDatabase } = require("./public/js/query.js"); // Adjust the path to query.js as per your directory structure
...
//NodeMailer to sent Send/Recieve Mails
const transporter = nodemailer.createTransport({
  host: "smtp.gmail.com",
  port: 587,
  secure: false, // Set to true if using SSL/TLS
  auth: {
    user: "gibson.25cs@licet.ac.in", // Replace with your email address
    pass: "GIBson6103", // Replace with your email password or app password
  },
});
